<?php
/**
 * Class for Multibanco alternative payment requests
 * @package SkrillPsp
 *
 */
class SkrillPsp_Multibanco extends SkrillPSPAlternativePayment
{
	  ...
	  {
	  	  throw new OutOfBoundsException("First name parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	   throw new OutOfBoundsException("Last name parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	throw new OutOfBoundsException("Salutation parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	throw new OutOfBoundsException("Customer street parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	throw new OutOfBoundsException("Customer zip parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	throw new OutOfBoundsException("Customer city parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	throw new OutOfBoundsException("Customer state parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	throw new OutOfBoundsException("Customer mobile parameter is not availbale for Multibanco");
	  }
	  ...
	  {
	  	throw new OutOfBoundsException("Customer phone parameter is not availbale for Multibanco");
	  }
